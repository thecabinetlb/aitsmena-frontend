...
<template>
    ...
    <InnerHero :pagebanner="banner" hyphen pagetitle="Resources" pagedescription="Need some resources to explore the complex world of software solutions and digital services? Welcome to the home of the latest industry news, insights, trends, and much more."/>
    <section class="relative -mt-40">
      <PostsCarousel sectionid="blog" hyphen sectiontitle="Blog" sectiondescription="Stay informed with the latest trends and developments in industrial automation. Explore our blog for thought-provoking articles, expert opinions, and practical industry tips to help your business stay ahead of the curve." :data='blogposts' />   
