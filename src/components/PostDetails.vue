...
<template>
    <section class="w-11/12 pt-40 mx-auto 2xl:w-8/12 lg:w-10/12">
        ...
        <div class="flex flex-col gap-3 mt-10">
            ...
            <p v-if="item.body" class="tracking-wide text-accent2 font-[200] max-sm:text-[14px] text-justify">{{ item.body }}</p>
            <div v-else class="tracking-wide text-accent2 font-[200] max-sm:text-[14px] text-justify">
