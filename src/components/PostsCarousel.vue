    ...
    <section>
        <div class="flex flex-wrap items-center w-full h-full gap-6 mt-40 lg:gap-0 lg:justify-between">
            <div class="lg:w-1/2 w-11/12 2xl:ps-[16.666667%] lg:ps-[8.333333%] lg:pe-6 mx-auto h-full">
                ...
                <RouterLink id="'go-to-blogs-page'" aria-label="go to blog page" to="/blogs" class="block cursor-pointer px-4 py-3 w-fit max-sm:text-[14px] font-[200] text-center rounded-[8px] shadow-lg text-accent1 bg-bg2 hover:brightness-125 mt-auto mb-0">Browes All</RouterLink>
            </div>            
            ...
            class="w-full h-full min-h-[40vh]">
                <slide v-for="item in data" :key="key" class="h-full rounded-[16px] border border-bg2">
