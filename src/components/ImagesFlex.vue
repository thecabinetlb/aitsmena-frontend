    ...
    <section class="w-11/12 h-full mx-auto mt-40 2xl:w-8/12 lg:w-10/12">
        ...
        <ul role="list" class="flex flex-wrap mt-10 justify-center lg;justify-between md:gap-3 gap-6 list-style-none">
            <li v-for="(item, key) in data" :key="key" class="relative lg:w-[32%] md:w-[49%] w-full flex-grow rounded-[16px]">
                ...
                <div class="p-63 w-10/12 h-fit absolute left-1/2 transform -translate-x-1/2 bottom-[8.333333%] rounded-[16px] bg-gradient-to-br from-accent1/10 to-accent1/30 backdrop-blur-[16px]">
