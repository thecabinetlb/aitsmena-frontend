...
<section>
    ...
    <div class="w-11/12 mx-auto 2xl:w-8/12 sm:w-10/12">
        ...
        <div v-show="openDetails === 2" class="traking-wide font-[200] max-sm:text-[14px] text-accent2 pb-10 mt-10">
        ...
        <div v-show="openDetails === 3" class="traking-wide font-[200] max-sm:text-[14px] text-accent2 pb-10 mt-10">
        ...
        <div v-show="openDetails === 4"  class="traking-wide font-[200] max-sm:text-[14px] text-accent2 pb-10 mt-10">
        ...
        <div v-show="openDetails === 5"  class="traking-wide font-[200] max-sm:text-[14px] text-accent2 pb-10 mt-10">
        ...
        <div v-show="openDetails === 6"  class="traking-wide font-[200] max-sm:text-[14px] text-accent2 pb-10 mt-10">
        ...
        <div v-show="openDetails === 7"  class="traking-wide font-[200] max-sm:text-[14px] text-accent2 pb-10 mt-10">
