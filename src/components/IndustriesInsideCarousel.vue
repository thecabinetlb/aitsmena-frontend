  ...
  <Transition name="slide-fade">
    <div v-if="openDetails === 1" class="pb-10 mt-10 space-y-6 traking-wide text-accent2">
        ...
        <ul role="list" class="list-disc ps-4">
            ...
            <li class="font-[200] max-sm:text-[14px]"><span class="font-[700]">Breaking down historical information silos and aggregating data from multiple sources</span> is another critical component. We provide actionable insights by consolidating data, improving operational transparency and supporting data-driven decision-making. This approach aligns with the SDG goals for sustainable consumption and production by optimizing resource use and minimizing waste.  </li>
