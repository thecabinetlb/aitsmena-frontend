...
<section>
  ...
  <Transition name="slide-fade">
    <div v-if="openDetails === 1" class="pb-10 mt-10 space-y-6 traking-wide text-accent2">
      ...
      <p class="font-[200] max-sm:text-[14px]">Seamless connectivity between diverse systems, sites, people, and assets is crucial.</p>
      <p class="font-[200] max-sm:text-[14px]">Our solutions ensure that various city components work harmoniously for effective urban management and reduced energy costs. This connectivity directly supports sustainability by building resilient and sustainable cities that improve urban living standards and reduce environmental impact.</p>
      <p class="font-[200] max-sm:text-[14px]">Breaking down information silos and aggregating data from multiple sources is another critical component. We provide actionable insights by consolidating data, improving operational transparency and supporting data-driven decision-making. This approach aligns with the SDG goals for sustainable consumption and production by optimizing resource use and minimizing waste.</p>
      <p class="font-[200] max-sm:text-[14px]">Our technology harmonizes data received from buildings, transportation networks, power systems, public utilities, security and communication infrastructures, providing a unified view of maintenance needs, predicting downtimes, and scheduling proactive maintenance. These smart solutions contribute to sustainable and resilient urban communities in line with sustainability goals.</p>
      <p class="font-[200] max-sm:text-[14px]">The increasing complexity of urban environments drives the need for centralized Command and Control Centers. Our solutions facilitate the integration of disparate data sources and multi-vendor systems, enabling efficient monitoring and management from a single control room, contributing to inclusive and well-managed urban environments.</p>
      <p class="font-[200] max-sm:text-[14px]">Addressing challenges such as urbanization, overpopulation, and congestion requires sophisticated networks and efficient infrastructure management. Our software supports the monitoring and management of multiple public operations, which is vital for sustainable urban development.</p>
      <p class="font-[200] max-sm:text-[14px]">By combining smart technologies with sustainable practices, we empower cities to achieve their development goals paving the way for a connected, sustainable urban future.</p>
      </div>       
</Transition>
  ...
  <Transition name="slide-fade">
      <div v-if="openDetails === 5" class="pb-10 mt-10 space-y-6 traking-wide text-accent2">
          <p class="font-[200] max-sm:text-[14px]">The water and wastewater sector is facing unprecedented challenges due to the increasing regulatory pressures, consumers demand, and environmental threats. The sector must prioritize ensuring access to clean water and sustainable water management for all, aligning with global efforts to enhance water quality and availability.</p>
          <p class="font-[200] max-sm:text-[14px]">According to the Sustainable Development Goals (SDGs), these efforts are essential for the well-being of communities and the long-term health of the ecosystems, especially with water becoming an increasingly scarce and priceless resource. The urgency of efficient management and conservation has never been more dire.</p>
          <p class="font-[200] max-sm:text-[14px]">Our comprehensive solutions empower utility operators to overcome these challenges through advanced tools, digitalization, and insights to optimize operations, reduce costs, and ensure long-term sustainability. These efforts align with sustainability goals regarding improving water-use efficiency to combat water scarcity.</p>
          <p class="font-[200] max-sm:text-[14px]">The push for change is driven by the need to better collect, analyze, and utilize large amounts of data generated across the sector. Real-time data analysis enhances transparency and supports decision-making enhancing integrated water resources management.</p>
          <p class="font-[200] max-sm:text-[14px]">In an age where every drop matters, quick, informed decision-making and regulatory compliance are essential to achieving sustainable water management. By enhancing water quality and reducing environmental impact, the sector can contribute to the improvement of water quality and minimizing pollution.</p>
     
          <h1 class="font-[700] text-lg">Water and Wastewater Management</h1>
          <p class="font-[200] max-sm:text-[14px]">Water and wastewater utilities are under immense pressure to deliver reliable, affordable services while adhering to stringent regulations. Balancing energy-intensive processes, such as water reclamation and desalination, with the need to maintain water quality and expand access to clean water, remains a key challenge. Effective water conservation, energy optimization, and stringent compliance monitoring are fundamental to achieving these goals and advancing the targets of sustainable goals, which ensure access to clean water and sanitation for all.</p>
