<template>
    <section class="w-11/12 mx-auto mt-40 2xl:w-8/12 lg:10/12">
      ...
      <div class="relative mt-10 space-y-20 z-5">
        <div class="flex flex-wrap items-center justify-center w-full gap-6 lg:justify-between"
        v-motion
          :initial="{
            opacity: 0,
            y: 100,
          ...
          <img src="../assets/images/hero/missionandvision/vision.webp" alt="AITS" width="391" height="290" center cover responsive loading="lazy"/>    
        </div>
        ...
        v-motion
          ...
          <img src="../assets/images/hero/values/values.webp" alt="AITS" width="391" height="290" center cover responsive loading="lazy"/>    
          <div class="w-full space-y-10 2xl:w-3/5 lg:w-1/2">
