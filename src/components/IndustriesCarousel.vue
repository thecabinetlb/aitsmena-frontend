    ...
    <section class="pt-40">
      ...
      <div class="relative w-full h-full z-[5]">
        <Carousel
          ...
          <Slide v-for="(item, key) in data" :key="item.id" class="relative aspect-square rounded-[16px] border-2 bg-noise bg-opacity-50 bg-cover bg-center my-10 border-bg2">
