...
<template>
  <section id="AITSHero" class="relative flex flex-col flex-wrap items-center h-full mx-auto">
    ...
    <div class="sm:10/12 w-11/12 flex flex-col justify-center items-center mx-auto space-y-4 gap-4 h-[90vh] pt-10">
      <h1 class="text-accent1 uppercase 2xl:text-9xl text-[30px] lg:text-7xl xl:text-8xl text-center font-[700]">Lorem Ipsum <br/><span class="font-[100]">Dolor Sit</span></h1>
    ...
    <div class="absolute inset-0 w-full h-full overflow-hidden">
      ...
      class="absolute left-0 transform z-2 top-1/2 -translate-y-1/2"/>
      ...
      class="absolute z-3 left-0 top-1/3 transform -translate-y-1/3"/>
    ...
    <!-- Mission and Values  -->
    <section class="w-11/12 mx-auto mt-40 pb-20 space-y-2 xl:w-8/12 sm:10/12">
