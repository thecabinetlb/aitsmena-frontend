<template>
  <section id="AITSHero" class="relative flex flex-col items-center h-full mx-auto"> 
    <!-- headline + cta -->
    <div class="sm:10/12 2xl:8/12  w-11/12 flex flex-col justify-center items-center mx-auto gap-6 h-[90vh] max-sm:px-6 pt-40">
      ...
      <p class="tracking-wide font-[200] max-sm:text-[14px] text-justify text-accent2 2xl:w-[675px] sm:w-2/3" style="text-align-last: center;">
        We combine our deep understanding of industrial challenges with our commitment to continuous innovation to deliver tailored software solutions that empower your business to thrive in an ever-evolving landscape. </p>
