<template>
   <section id="contact" class="relative mt-40 bg-gradient-to-r from-accent1/10 to-accent1/20 lg:min-h-[50vh] md:min-h-[60vh] min-h-[50vh] flex flex-col items-center justify-center px-6 overflow-hidden">
    <div class="relative mx-auto text-center 2xl:w-8/12 sm:w-10/12 w-11/12 z-[1] space-y-10">
      <h1 class="text-accent1 2xl:text-6xl lg:text-5xl sm:text-5xl text-4xl uppercase text-center font-[400]">Contact Us</h1>
      <p class="font-[200] text-justify text-accent2 2xl:w-1/2 w-2/3 mx-auto" style="text-align-last: center">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu.</p>
