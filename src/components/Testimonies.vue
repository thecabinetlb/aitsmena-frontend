...
const testimoniesslided = [
    { id: 1, title: 'We are in a good company', ceo:'Samir A.', content: '"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim quis nostrud exercitation ullamco laboris nisi ut aliquip."', icon: client1 },
    { id: 2, title: 'We are in a good company', ceo:'Malak H.', content: '"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim quis nostrud exercitation ullamco laboris nisi ut aliquip."', icon: client1 },
];
</script>
...
<template>
  <section class="mt-20 PY-20">
    ...
    class="w-9/12 mx-auto">
        <slide v-for="slide in testimoniesslided" :key="slide.id" class="space-y-4">
            <h1 class="text-accent1 font-[400] 2xl:text-5xl lg:text-4xl text-[30px]">
                {{ slide.title }}
            </h1>
            <p class="text-accent2 font-[200] 2xl:text-xl lg:text-lg text-justify italic" style="text-align-last: center;">{{ slide.content }}</p>
