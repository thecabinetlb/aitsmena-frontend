import { ref, mergeProps, unref, withCtx, createVNode, createTextVNode, toDisplayString, useSSRContext, resolveComponent, resolveDirective, reactive, watch, openBlock, createBlock, Fragment, renderList, onMounted } from "vue";
...
const _sfc_main$o = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="sm:10/12 w-11/12 flex flex-col justify-center items-center mx-auto gap-6 h-[90vh] lg:pt-40 pt-40"><h1 class="text-accent1 uppercase 2xl:text-9xl lg:text-8xl md:text-6xl sm:text-5xl text-[36px] text-center font-[700]">AITS</h1><h1 class="text-accent1 uppercase 2xl:text-7xl lg:text-6xl md:text-5xl sm:text-4xl text-[30px] text-center font-[700]">Where Innovation<br> Knows No Limits</h1><p class="font-[200] max-sm:text-[14px] text-justify text-accent2 2xl:w-5/12 px-4 sm:w-2/3" style="${ssrRenderStyle({ "text-align-last": "center" })}"> Looking for a trusted partner in the industrial software field? AITS empowers industries like yours to thrive through innovative tech solutions tailored to your unique needs.</p>`);
      _push(ssrRenderComponent(unref(RouterLink), {
  ...
  setup(__props) {
    const csr = [
      {
        ...
        description: "Inclusivity within our workplace culture is crucial, where everyone, regardless of gender, has equal opportunities for growth and success. Gender equality is promoted through:",
        initiatives: [
          "Diverse Workforce",
          "Equal Opportunities",
          "Supportive Policies"
      ...
      },
      {
        ...
        description: "When they feel good, we feel good. AITS employees are our greatest asset and their well-being is our top priority. A supportive work environment makes them feel valued, empowered, and motivated to excel. Our employee-first approach includes:",
        initiatives: [
          "Health and Safety",
      ...
      },
      {
        ...
        description: "Practice makes perfect. We strive to continuously improve in all aspects of our business operations to attain excellence in performance, efficiency, and sustainability. This requires:",
        initiatives: [
          "Quality Management",
          "Innovation",
          "Sustainability"
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$f, {
        ...
        sectiondescription: "AITS takes pride in holding two distinguished sub-companies: AVEVA Select Gulf and IC2. Together, we offer a comprehensive suite of solutions designed to address the diverse challenges faced by today's industries.",
        data: partners
      }, null, _parent));
      _push(ssrRenderComponent(_sfc_main$e, {
        sectiontitle: "Because We Care",
        data: csr,
...
const client1 = "/images/testimonies/client1.svg";
...
const _sfc_main$b = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({
        id: "testimonials",
        class: "relative pt-40 mx-auto"
      }, _attrs))} data-v-9110b728><div class="w-11/12 mx-auto 2xl:w-8/12 lg:w-10/12" data-v-9110b728><h1 class="text-accent1 font-[200] text-lg uppercase" data-v-9110b728> • What Our Clients Think</h1><hr class="w-full h-4 mt-3 text-accent2" data-v-9110b728></div><div class="relative w-11/12 h-full mx-auto mt-10 2xl:w-8/12 lg:w-10/12" data-v-9110b728>`);
      _push(ssrRenderComponent(unref(Carousel), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<!--[-->`);
            ssrRenderList(testimoniesslides, (slide, index) => {
              _push2(ssrRenderComponent(unref(Slide), {
                key: index,
                class: "relative flex items-center justify-center w-full h-full py-10"
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<blockquote class="max-w-screen-lg mx-auto text-center 2xl:max-w-screen-md md:max-w-screen-sm" data-v-9110b728${_scopeId2}><p class="text-accent2 text-3xl font-[200] max-sm:text-[14px] text-jusify" style="${ssrRenderStyle({ "text-align-last": "center" })}" data-v-9110b728${_scopeId2}>${ssrInterpolate(slide.content)}</p></blockquote><figcaption class="flex items-center justify-center gap-2 mt-6" data-v-9110b728${_scopeId2}><cite class="text-accent2 font-[400]" data-v-9110b728${_scopeId2}>${ssrInterpolate(slide.ceo)}</cite><img${ssrRenderAttr("src", slide.icon)}${ssrRenderAttr("alt", slide.title)} width="40" height="40" class="rounded-[8px]" loading="lazy" data-v-9110b728${_scopeId2}></figcaption>`);
                  } else {
                    return [
                      createVNode("blockquote", { class: "max-w-screen-lg mx-auto text-center 2xl:max-w-screen-md md:max-w-screen-sm" }, [
                        createVNode("p", {
                          class: "text-accent2 text-3xl font-[200] max-sm:text-[14px] text-jusify",
                          style: { "text-align-last": "center" }
                        }, toDisplayString(slide.content), 1)
                      ]),
                      createVNode("figcaption", { class: "flex items-center justify-center gap-2 mt-6" }, [
                        createVNode("cite", { class: "text-accent2 font-[400]" }, toDisplayString(slide.ceo), 1),
                        createVNode("img", {
                          src: slide.icon,
                          alt: slide.title,
                          width: "40",
            ...
            return [
              (openBlock(), createBlock(Fragment, null, renderList(testimoniesslides, (slide, index) => {
      ...
      _push(`<div class="absolute left-0 items-center justify-between hidden w-full h-full px-6 mx-auto md:flex -top-10 z-2" data-v-9110b728><button aria-label="go to the next testimony" class="text-accent2 hover:text-accent1 text-2xl w-[44px] h-[44px] cursor-pointer aspect-square grid place-content-center border-2 border-accent2 hover:border-accent1 rounded-full" data-v-9110b728> 🡠 </button><button aria-label="go to the prev testimony" class="text-accent2 hover:text-accent1 text-2xl w-[44px] h-[44px] cursor-pointer aspect-square grid place-content-center border-2 border-accent2 hover:border-accent1 rounded-full" data-v-9110b728> 🡢 </button></div></div></section>`);
    };
  }
};
...
const _sfc_main$a = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section class="relative">`);
      _push(ssrRenderComponent(_sfc_main$c, { data: industries }, null, _parent));
      _push(ssrRenderComponent(_sfc_main$j, null, null, _parent));
      _push(`</section><!--]-->`);
    };
  }
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({
        ...
        class: "w-11/12 pt-40 mx-auto 2xl:w-8/12 lg:w-10/12"
      }, _attrs))}><h1 class="font-[500] text-accent1 2xl:text-6xl lg:text-5xl md:text-4xl text-[30px] uppercase mb-6">${ssrInterpolate(__props.sectiontitle)}</h1><p class="text-accent2 font-[200] max-sm:text-[14px] text-justify">${ssrInterpolate(__props.sectiondescription)}</p><ul role="list" class="flex flex-col mt-10 flex-wrap gap-10 w-full h-full p-10 bg-gradient-to-r from-accent1/10 to-accent1/20 rounded-[16px] list-style-none"><!--[-->`);
      ssrRenderList(__props.data, (item, key) => {
        _push(`<li class="${ssrRenderClass([{ "lg:border-none": key === 2 }, "flex items-center justify-between flex-grow w-full h-full gap-3 border-b lg:min-h-[108px] pb-3 max-sm:flex-wrap border-accent1"])}"><h1 class="sm:w-2/12 w-full font-[400] 2xl:text-6xl lg:text-5xl md:text-4xl text-[30px] text-accent1">0${ssrInterpolate(item.id)}</h1><div class="w-full lg:w-10/12"><p class="text-accent2 font-[200] max-sm:text-[14px] text-justify">${ssrInterpolate(item.title)}</p></div></li>`);
      });
      _push(`<!--]--></ul><p class="text-accent2 font-[200] max-sm:text-[14px] text-justify mt-10">Unlock the full potential of your career journey with AITS, where your talents are nurtured, and your aspirations are embraced.</p></section>`);
    };
  }
};
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$k, {
        ...
        pagetitle: "Resources",
        pagedescription: "Need some resources to explore the complex world of software solutions? Welcome to the home of the latest industry news, insights, trends, and much more."
      }, null, _parent));
      _push(`<section class="relative -mt-40">`);
...
const routes = [
  { path: "/", component: _sfc_main$l },
  { path: "/about", component: _sfc_main$d },
  { path: "/contact", component: _sfc_main$g },
