...
import { ref, mergeProps, unref, withCtx, createVNode, createTextVNode, toDisplayString, useSSRContext, resolveComponent, resolveDirective, defineAsyncComponent } from "vue";
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrInterpolate, ssrRenderStyle, ssrGetDirectiveProps, ssrRenderClass } from "vue/server-renderer";
import { RouterLink, useRoute, createRouter, createMemoryHistory, createWebHistory } from "vue-router";
...
const _sfc_main$j = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><h1 class="text-accent1 font-[200] text-lg uppercase">${ssrInterpolate(__props.sectiontitle)}</h1><hr class="w-full h-4 mt-3 text-accent2"><div class="${ssrRenderClass([{ "lg:flex-row-reverse": __props.reverse }, "flex flex-wrap items-center justify-center w-full gap-6 mt-10 lg:gap-3 lg:justify-between"])}"><div class="w-full lg:w-6/12"><h2 class="font-[200] text-accent1 2xl:text-6xl lg:text-5xl md:text-4xl text-[30px] uppercase mb-6">${ssrInterpolate(__props.item.title)}</h2><p class="text-accent2 font-[200] max-sm:text-[14px] text-justify mb-6">${ssrInterpolate(__props.item.description)}</p>`);
      if (__props.item.to) {
        _push(ssrRenderComponent(unref(RouterLink), {
...
const _sfc_main$e = {
  ...
  setup(__props) {
    const ContactForm = defineAsyncComponent(
      () => import("./assets/ContactForm-BThMqsNr.js")
    );
    const locations = [
      {
        id: 1,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$h, {
        ...
        pagetitle: "Contact",
        pagedescription: "Get in touch to learn more about our industry software solutions, digital services and how you can take your business a step further!"
      }, null, _parent));
      _push(`<div class="relative">`);
      _push(ssrRenderComponent(unref(ContactForm), null, null, _parent));
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({
        id: __props.sectionid,
        class: "w-11/12 pt-40 mx-auto 2xl:w-8/12 lg:w-10/12"
      }, _attrs))}><h1 class="font-[500] text-accent1 2xl:text-6xl lg:text-5xl md:text-4xl text-[30px] uppercase mb-6">${ssrInterpolate(__props.sectiontitle)}</h1><p class="text-accent2 font-[200] max-sm:text-[14px] text-justify">${ssrInterpolate(__props.sectiondescription)}</p><div class="flex flex-wrap justify-center gap-3 mt-10 lg:justify-end"><button class="${ssrRenderClass([{ "border-b-2 border-accent1": clicked.value === 0, "border-b-2 border-bg2": clicked.value !== 0 }, "px-4 py-3 w-fit h-fit bg-gradient-to-r from-accent1/10 to-accent1/20 backdrop-blur-[16px] rounded-[16px] text-accent1 bg-transparent hover:border-accent1 focus:outline-none focus:ring-0 focus:border-accent1 peer"])}"> Diversity &amp; Inclusion</button><button class="px-4 py-3 w-fit h-fit bg-gradient-to-r from-accent1/10 to-accent1/20 backdrop-blur-[16px] rounded-[16px] text-accent1 bg-transparent border-b-2 hover:border-accent1 border-bg2 focus:outline-none focus:ring-0 focus:border-accent1 peer"> Our People First</button><button class="px-4 py-3 w-fit h-fit bg-gradient-to-r from-accent1/10 to-accent1/20 backdrop-blur-[16px] rounded-[16px] text-accent1 bg-transparent border-b-2 hover:border-accent1 border-bg2 focus:outline-none focus:ring-0 focus:border-accent1 peer"> Continuous Improvement</button></div><div class="flex flex-wrap items-center justify-center w-full gap-6 mt-10 lg:gap-3 lg:justify-between max-lg:flex-col-reverse"><img${ssrRenderAttr("src", filterdata.value.image)}${ssrRenderAttr("alt", filterdata.value.title)} width="391" height="290" center cover responsive loading="lazy"><div class="w-full lg:w-6/12"><h2 class="font-[200] text-accent1 2xl:text-6xl lg:text-5xl md:text-4xl text-[30px] uppercase mb-6">${ssrInterpolate(filterdata.value.title)}</h2><p class="text-accent2 font-[200] max-sm:text-[14px] text-justify">${ssrInterpolate(filterdata.value.description)}</p></div></div></section>`);
    };
  }
};
...
const _sfc_main$a = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "w-11/12 mx-auto 2xl:w-8/12 lg:w-10/12" }, _attrs))}><h1 class="text-accent1 font-[200] text-lg uppercase"> Industries we serve</h1><hr class="w-full h-4 mt-3 text-accent2"><div class="grid relative w-full justify-center items-center grid-cols-2 md:grid-cols-4 2xl:grid-cols-7 gap-6 md:mb-[194px] mt-10 max-md:pb-10"><!--[-->`);
      ssrRenderList(__props.data, (item, key) => {
      ...
      ssrRenderList(__props.data, (item, key) => {
        ...
        ])}" class="md:block absolute hidden 2xl:left-1/2 2xl:transform 2xl:-translate-x-1/2 2xl:w-9/12 2xl:px-6 top-[100%] my-10 md:h-[194px] font-[200] max-sm:text-[14px] text-justify text-accent2">${ssrInterpolate(item.description)}</p>`);
      });
      _push(`<!--]--></div><!--[-->`);
      ssrRenderList(__props.data, (item, key) => {
        _push(`<p style="${ssrRenderStyle([
...
const _sfc_main$9 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section class="relative">`);
      _push(ssrRenderComponent(_sfc_main$a, { data: industries }, null, _parent));
      _push(ssrRenderComponent(_sfc_main$g, null, null, _parent));
      _push(`</section><!--]-->`);
    };
  }
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.data) {
        ...
        _push(`<div class="lg:w-full relative group bg-extended-noise bg-cover bg-center bg-opacity-50 rounded-[16px] mt-10 mx-auto"><div class="px-10 py-6 relative flex justify-between items-center gap-3 rounded-[16px] bg-gradient-to-br from-accent1/10 to-accent1/30 border-2 border-bg2"><h3 class="2xl:text-2xl lg:text-xl sm:text-lg text-accent1 font-[500]">No posted ${ssrInterpolate(__props.sectionid)}.</h3></div></div>`);
      }
      _push(`</section>`);
    };
  }
...
const _sfc_main$6 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$7, { sectiontitle: "Employees Benefits" }, null, _parent));
      _push(ssrRenderComponent(_sfc_main$g, null, null, _parent));
      _push(`</section><!--]-->`);
    };
  }
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    const PostsCarousel = defineAsyncComponent(
      () => import("./assets/PostsCarousel-D7mQA1O3.js")
    );
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section class="relative -mt-40">`);
      _push(ssrRenderComponent(unref(PostsCarousel), {
        sectionid: "blog",
        sectiontitle: "Blog",
...
const routes = [
  { path: "/", component: _sfc_main$i },
  { path: "/about", component: _sfc_main$b },
  { path: "/contact", component: _sfc_main$e },
  { path: "/industries", component: _sfc_main$9 },
  { path: "/careers", component: _sfc_main$6 },
